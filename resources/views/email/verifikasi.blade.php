            ...
            <div
                ...
                <div style="box-sizing:border-box;display:block!important">
                    ...
                    <p style="box-sizing:border-box;margin-top:0;margin-bottom:1rem;display:block!important">
                        Terima kasih telah validasi untuk reset password akun kamu di <span class="il">Kopitu e-store</span>. Berikut adalah
                ...
                <div style="box-sizing:border-box;display:block!important">
                    Pastikan anda melakukan aktivasi akun, harap lakukan aktivasi akun untuk mereset password akun anda dengan mengklik tombol di bawah ini:
                </div>
                ...
                <div
                    ...
                    <a href="https://kopitu.com/register/validasi/key={{ $details['key'] }}"
                    ...
                    <div
                        ...
                        <div style="box-sizing:border-box;min-height:1px;padding:1.25rem;color:#343a40!important">
                            ...
                            <a href="https://kopitu.com/register/validasi/key={{ $details['key'] }}"
                                ...
                                target="_blank">
                                https://kopitu.com/register/validasi/key={{ $details['key'] }}
                            </a>
                        </div>
                    </div>
                </div>
                <div style="box-sizing:border-box;display:block!important">
                    <p style="box-sizing:border-box;margin-top:0;margin-bottom:.5rem!important;display:block!important">
                        Harap lakukan aktivasi akun anda dalam tempo 12 jam, jika tidak melakukan aktivasi maka
                        pendaftaran akan dibatalkan dan Anda harus mendaftar lagi.
                    </p>
                    <p style="box-sizing:border-box;margin-top:0;margin-bottom:1rem;display:block!important">
