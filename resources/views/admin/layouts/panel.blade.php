...
<head>
    ...
    <link rel="stylesheet" href="{{ url('/dist/assets/css/admin/panel.css') }}">
        ...
        <div class="slider" id="sliders">
            ...
            <div class="slider-body px-1">
                <nav class="nav flex-column" id="nav-acordion">
                    ...
                    <a class="nav-link px-3" href="#product" type="button" data-bs-toggle="collapse"
                        data-bs-target="#productions">
                        <i class="fas fa-box box-icon"></i>Product
                    </a>
                    <div id="productions" class="accordion-collapse collapse" data-bs-parent="#nav-accordion">
                        <a class="nav-link ps-4" href="{{ route('admin.product') }}">
                            <i class="fas fa-boxes box-icon"></i>Data Product
                        </a>
                        <a class="nav-link ps-4" href="{{ route('admin.product.category.index') }}">
                            <i class="fas fa-list-alt box-icon"></i>Category Product
                        </a>
                    </div>
                    <a class="nav-link px-3" href="{{ route('admin.transaction') }}">
                    ...
                    <a class="nav-link px-3" href="{{ route('admin.news') }}">
                        <i class="fas fa-images box-icon" aria-hidden="true"></i>Banner
                    </a>
                    <a class="nav-link px-3" href="#">
